...
def data_name2nc(data_name: str):
    ...
    if data_name == 'MSL':
        ...
        nc = 1
    elif data_name == 'NIPS_TS_Swan' or data_name == 'Swan':
        nc = 38
...
def get_loader_segment(index, data_path, batch_size, win_size=100, step=1, mode='train', dataset='MSL', dist=0, ret_data=False):
    if (dataset == 'SMD'):
